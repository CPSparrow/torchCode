...
def make_data():
	...
	while positive != batch_size / 2 or negative != batch_size / 2:
		tokens_a_index, tokens_b_index = random.randrange(len(sentences)), random.randrange(
...
loader = Data.DataLoader(MyDataSet(input_ids, segment_ids, masked_tokens, masked_pos, isNext),
						 batch_size, True)
...
class MultiHeadAttention(nn.Module):
	...
	def forward(self, Q, K, V, attn_mask):
		...
		context = (context.transpose(1, 2).contiguous().
				   view(batch_size, -1, n_heads * d_v))  # context: [batch_size, seq_len, n_heads, d_v]
...
for epoch in range(100):
	for input_ids, segment_ids, masked_tokens, masked_pos, isNext in loader:
		...
		loss.backward()
		optimizer.step()
print("train consumed {}s", time.time() - start)
