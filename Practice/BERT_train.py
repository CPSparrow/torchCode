...
bookcorpus = datasets.load_dataset("bookcorpus", split="train", trust_remote_code=True)
# wiki = datasets.load_dataset("./wikipedia/data/20220301.en/")
# 仅保留 'text' 列
# wiki = wiki.remove_columns([col for col in wiki.column_names if col != "text"])
dataset_raw = datasets.concatenate_datasets([bookcorpus])
